...
const future = new Date(2037, 10, 19, 15, 23);
console.log(Number(future)); // 2142224580000. timestamp
console.log(+future);
...
const days1 = calcDaysPassed(
  new Date(2037, 3, 4),
  new Date(2037, 3, 14)
  // new Date(2037, 3, 14, 10, 8) // 10.422222222222222
  // Math.round(Math.abs(date2 - date1) / (1000 * 60 * 60 * 24));
);
console.log(days1);
...
const options = {
  ...
  style: 'currency',
  currency: 'EUR',
  // useGrouping: false, // without separator
};

console.log('US: ', new Intl.NumberFormat('en-US', options).format(num)); // 36,483,334.23
console.log('Germany: ', new Intl.NumberFormat('de-DE', options).format(num)); // 36.483.334,23
console.log(
  navigator.language,
